...
namespace WTG.Analyzers
{
	static class Rules
	{
		...
		public static readonly DiagnosticDescriptor UseCorrectEmitOverloadRule = new DiagnosticDescriptor(
			...
			DiagnosticSeverity.Warning,
			isEnabledByDefault: true,
			description: "The emit methods generally don't pay attention to the opcode when emitting the operand, so using the wrong overload may result in unexpected behaviour that is difficault to debug.");
